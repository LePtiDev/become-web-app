...
-->
  <div class="min-h-full">
    <nav class="drop-shadow-sm bg-gray-800">
      <div class="px-24">
        <div class="flex items-center justify-between h-16">
          <div class="flex items-center">
            <div class="flex-shrink-0 text-white">Become</div>
            <div class="hidden md:block">
              <div class="ml-10 flex items-baseline space-x-4">
                <router-link
                  ...
                  :class="$route.name === navlink.link ? 'bg-indigo-700 text-white px-3 py-2 rounded-md text-sm font-medium' : 'text-white hover:bg-indigo-500 hover:bg-opacity-75 px-3 py-2 rounded-md text-sm font-medium'"
              ...
              <div class="ml-3 relative">
                <div>
                  <button
                    ...
                    type="button"
                    class="max-w-xs text-white p-2 bg-indigo-600 rounded-full flex items-center text-sm focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-indigo-600 focus:ring-white"
                    id="user-menu-button"
                    aria-expanded="false"
                    aria-haspopup="true"
                  >
                ...
                >
                  <div
                    ...
                    tabindex="-1"
                  >
                    <a href="#" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100" role="menuitem" tabindex="-1" id="user-menu-item-0">Mon profile</a>
                    <a href="#" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100" role="menuitem" tabindex="-1" id="user-menu-item-2">Me déconnecter</a>
                  </div>
                </transition>
              </div>
            </div>
